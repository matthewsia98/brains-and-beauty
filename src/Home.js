...
export const productList = [
  {
    ...
    directions:
      "This product is recommended for evening use, applied with a saturated cotton pad on cleansed face and neck, avoiding sensitive areas. It should not be rinsed off, and caution should be exercised regarding skin contact frequency and duration. Sunscreen and limited sun exposure are advised due to increased sun sensitivity caused by the product's alpha hydroxy acid content.",
  ...
  },
  {
    ...
    ingredient_list:
      "Lauric Acid, Glycerin, Camellia Sinensis, Epilobium Angustifolium Extract, Salicylic Acid, Avena Sativa Kernel Extract, Glycyrrhiza Glabra, Allantoin",
    description:
  ...
  },
  {
    ...
    brand: "Paula's Choice",
    ingredient_list:
      "Azelaic Acid, Salicylic Acid, Adenosine, Allantoin, Boerhavia Diffusa Root Extract.",
    description:
    ...
    directions:
      "Once or twice daily, apply to face and neck. May be used alone or added to your favorite moisturizer or serum. For daytime, always follow with a sunscreen. If you have a salicylate allergy, check with your physician before using any products that contain salicylic acid.",
  ...
  },
  {
    ...
    directions:
      "Start by cleansing your face, then pat dry. Gently massage the cream into your face and neck. Use every evening.",
...

  {
    ...
    description:
      "Cerave Skin Renewing Vitamin C Serum is a potent yet gentle lightweight serum containing 10% pure Vitamin C. It helps brighten the complexion, promote even skin tone, and improve texture. Enriched with essential Ceramides, Hyaluronic Acid, and vitamin B5, it restores the skin's barrier, enhances hydration, and leaves the skin soft, radiant, and healthy-looking.",
    category: ["face"],
    active_ingredient: ["Ascorbic Acid"],
    price: "25.00",
    target_concerns: ["Dullness", "Signs of Aging"],
    directions:
      "Apply the product evenly to the face and neck on a daily basis, taking care to avoid the eye area. In case of contact with the eyes, rinse thoroughly with water. It is recommended to store the product in a cool, dark place to maintain its quality.",
...

  {
    ...
    ingredient_list:
      "Water (Aqua), Glycerin, Cetyl Alcohol, Dimethicone, Ethylhexyl Palmitate, Sodium Hyaluronate, Retinol, Niacinamide, Tocopherol, Panthenol, Phenoxyethanol, Ethylhexylglycerin, Xanthan Gum, Sodium Benzoate, Potassium Sorbate, Citric Acid.",
    description:
      "The Retinol B3 Anti-Aging face serum and neck serum for aging skin and sensitive skin helps skin look smoother, more luminous, and renewed. Progressively, skin firmness recovers and photoaging signs are reduced: deep wrinkles, irregular skin texture and uneven skin complexion. Worked with dermatologists, this serum is a unique complex of pure and gradual retinol for a continuous and potent anti-wrinkle action, combined with vitamin B3 (niacinamide) for an optimal regenerating efficacy while also being suitable for sensitive skin.",
    category: ["face"],
    active_ingredient: ["Retinol", "Niacinamide"],
    price: "67.55",
    target_concerns: ["Signs of Aging"],
    directions:
      "Cleanse your skin with Micellar Foaming Water. Apply 3 to 4 drops of Retinol B3 Serum in the evening on the face and neck, avoiding the eye area. Use alone or mix with moisturizer. Apply SPF during the day and store the serum in a cool, dark place for stability.",
  ...
  },
  {
    ...
    description:
      "Multi-Peptide + HA Serum (formerly known as “Buffet”) is a universal formula that combines a comprehensive array of technologies to improve skin smoothness and target multiple signs of aging at once. By utilizing four well-studied peptide technologies, skin-friendly amino acids, and multiple hyaluronic acid complexes, it helps significantly improve the appearance of crow's feet, as well as improving the feel of skin elasticity and firmness.\n This formula contains SYN™-AKE, Matrixyl™ synthe'6™, Matrixyl™ 3000, ARGIRELOX™ peptide, Hyaluronic Acid, Amino Acids, and Bio-Derivatives",
    category: ["face"],
  ...
  },
  {
    ...
    directions:
      "Apply a small amount to clean skin. May be used daily for all-over smoothing, or applied as a spot treatment where needed. Apply this treatment first when using with a moisturizer. For daytime, follow with a broad-spectrum sunscreen rated SPF 30 or greater.",
  ...
  },
  {
    ...
    brand: "Paula's Choice",
    ingredient_list:
      "Water, Dipropylene Glycol, Butylene Glycol, Polysorbate 20, Pentylene Glycol, Salicylic Acid, Panthenol, Sodium Hyaluronate, Dipotassium Glycyrrhizate, Glycyrrhiza Glabra (Licorice) Root Extract, Berberis Vulgaris Root Extract, Lauric Acid, Allantoin, Glycerin, PEG/PPG-17/6 Copolymer, Methyl Gluceth-20, Glycereth-26, Sodium Hydroxide, Sodium Metabisulfite, Disodium EDTA, Potassium Sorbate.",
    description:
      "A body exfoliant with salicylic acid that fights acne fast and prevents new breakouts while calming redness. The easy-to-use spray can be held at any angle to reach stubborn acne on hard-to-reach areas of the body.",
    category: ["body"],
    active_ingredient: ["Salicylic Acid"],
    price: "22.43",
    target_concerns: ["Acne"],
  ...
  },
  {
    ...
    brand: "Aveeno",
    ingredient_list:
      "Water (eau), Glycerin, Distearyldimonium Chloride, Petrolatum, Isopropyl Palmitate, Cetyl Alcohol, Panthenol, Dimethicone, Avena Sativa (Oat) Kernel Flour, Benzyl Alcohol, Steareth-20, Aloe Barbadensis Leaf Extract, Sodium Chloride, Avena Sativa (Oat) Kernel Extract.",
    description:
  ...
  },
  {
    ...
    brand: "Eucerin",
    ingredient_list:
      "Water/Eau/Aqua, Sodium Cocoamphoacetate, Sodium Myreth Sulfate, Lauryl Glucoside, Citric Acid, Sodium Chloride, Methylpropanediol, Panthenol, Sodium Citrate, Polyquaternium-10, Coco Glucoside, PEG-40 Hydrogenated Castor Oil, Glycol Distearate, Glycerin, PEG-200 Hydrogenated Glyceryl Palmate, Sodium Benzoate",
    description:
      "This gentle cleanser for body & face can be used daily. It gently cleanses,  protecting the skin from drying out and supports the skin’s pH balance.",
    category: ["face", "body"],
    active_ingredient: ["Glycerin"],
    price: "12.45",
    target_concerns: ["Dryness", "Eczema"],
    directions:
      "To use, apply the product to both the face and body, ensuring the skin is wet while avoiding the delicate eye area. Then, gently massage the product onto the skin to create a lather. Once done, thoroughly rinse off the product and gently pat the skin dry.",
  ...
  },
  {
    ...
    description:
      "Enjoy daily sun protection with a light, non-greasy feel with this broad-spectrum SPF 30 sunscreen. This fast-absorbing body sunscreen combines soothing oat and 100% mineral active ingredients and is ideal for sensitive skin.",
    category: ["sun"],
  ...
  },
  {
    ...
    target_skinType: ["Dry", "Acne Prone"],
    directions:
      "Unlock the pump for first time use by twisting it to the left and pressing down several times until the product comes out. Apply liberally to the face and neck in the morning 15 minutes before sun exposure.",
  ...
  },
  {
    ...
    brand: "Neutrogena",
    ingredient_list:
      "Acrylates/Dimethicone Copolymer, Alcohol Denat. , Aluminum Starch Octenylsuccinate, Butyloctyl Salicylate, Chlorphenesin, Dimethicone, Disodium EDTA, Glycerin, Glyceryl Stearate, Pentylene Glycol, Phenoxyethanol, Polyurethane-62, Silica, Sodium Acryloyldimethyltaurate/VP Crosspolymer, Sodium Hydroxide, Styrene/Acrylates Copolymer, Tocopheryl Acetate, Trideceth-6, Water (eau).",
    description:
      "Neutrogena® Ultra Sheer® Moisturizing Face Serum Sunscreen SPF 50+ moisturizes and helps protect your skin against sun damage. This sheer face sunscreen offers broad spectrum UVA/UVB protection and hydration in one-step.",
    category: ["sun"],
    uv_filters: {
      Homosalate: "13.5%",
      Octocrylene: "10%",
    ...
    target_skinType: ["Dry", "Acne Prone"],
    directions:
      "Adults and children over 6 months of age: Apply generously 15 minutes before sun exposure. Reapply at least every 2 hours. Reapply after 80 minutes of swimming or sweating. Reapply immediately after towel drying",
  ...
  },
  {
    ...
    brand: "Paula's Choice",
    ingredient_list:
      "Water⁠, Cyclopentasiloxane⁠, Zinc Oxide⁠, PEG-12 Dimethicone⁠, PEG/PPG-18/18 Dimethicone⁠, Lauroyl Lysine⁠, Sodium Chloride⁠, Trihydroxystearin⁠, Dimethicone Crosspolymer⁠, Resveratrol⁠, Quercetin⁠, Epigallocatechin Gallate⁠, Tocopheryl Acetate⁠, Tetrahexyldecyl Ascorbate⁠, Adenosine⁠, Bisabolol⁠, Salix Nigra (Willow) Bark Extract⁠, Punica Granatum Extract⁠, Haematococcus Pluvialis Extract⁠, Hydrolyzed Corn Starch⁠, Polysorbate 80⁠, Hydrated Silica⁠, Triethoxycaprylylsilane⁠, C12-15 Alkyl Benzoate⁠, Isopropyl Titanium Triisostearate⁠, Caprylyl Glycol⁠, Hexylene Glycol⁠, Ethylhexylglycerin⁠, Iron Oxides⁠, Phenoxyethanol⁠",
    description:
      "This lightly tinted mineral-based formula provides excellent sun protection while delivering state-of-the-art antioxidants to fortify the skin. It effectively prevents premature aging and boosts the skin's environmental defenses. With its silky texture, it leaves a soft matte finish, making it the ideal last step in your AM skincare routine.",
    category: ["sun"],
  ...
  },
  {
    ...
    brand: "Eucerin",
    ingredient_list:
      "Aqua, C12-15 Alkyl Benzoate, Alcohol Denat., Butyl Methoxydibenzoylmethane, Ethylhexyl Triazone, Butylene Glycol DicaprylateDicaprate, Bis-Ethylhexyloxyphenol Methoxyphenyl Triazine, Dibutyl Adipate, Glyceryl Stearate Citrate, Silica, Phenylbenzimidazole Sulfonic Acid, Diethylamino Hydroxybenzoyl Hexyl Benzoate, Tapioca Starch, Silica Dimethyl Silylate, Cetearyl Alcohol, Glycyrrhiza Inflata Root Extract, Glycyrrhetinic Acid, Tocopheryl Acetate, Glycerin, Copernicia Cerifera Cera, Xanthan Gum, Carrageenan, Hydroxypropyl Methylcellulose, Sodium Hydroxide, Trisodium EDTA, Hydroxyacetophenone, Phenoxyethanol, Ethylhexylglycerin, Parfum.⁠",
    description:
      "A superior facial sunscreen for all skin types that prevents sun-induced hyperpigmentation. Effectively reduces dark spots and prevents their re-appearance. Eucerin’s Advanced Spectral Technology offers high factor UVA/UVB protection and HEVIS light defense. The sunscreen also supports skin’s own DNA repair mechanism.",
    category: ["sun"],
    uv_filters: {
      Homosalate: "13.5%",
      Octocrylene: "10%",
  ...
  },
  {
    ...
    description:
      "Ultra-light, oil-free face sunscreen lotion with an invisible matte finish with NETLOCK technology.",
    category: ["sun"],
    uv_filters: {
      Homosalate: "13.5%",
      Octocrylene: "10%",
  ...
  },
  {
    ...
    brand: "Aveeno",
    ingredient_list:
      "Colloidal Oatmeal Extract, Cetyl Alcohol, Cetearyl Alcohol, Behentrimonium Chloride, Glycerin, Amodimethicone, Steareth-20, Hydrolyzed Milk Protein, Prunus Amygdalus Dulcis (Sweet Almond) Seed Extract, PPG-3 Benzyl Ether Myristate, Polyquaternium-47, Polyquaternium-37, PPG-1 Trideceth-6, Propylene Glycol Dicaprylate/Dicaprate, Water/Aqua/Eau, Isopropyl Alcohol, Disodium EDTA, Citric Acid, Sodium Hydroxide, Sodium Benzoate, Fragrance/Parfum.⁠",
    description:
      "Oat is the first ingredient in this scalp-soothing, farm-fresh inspired conditioner infused with almond milk for lightly nourished, soft strands. Balanced moisture for daily use and all hair types makes it the perfect conditioner for an entire family. Sulfate free conditioner, no dyes or parabens.",
    category: ["hair"],
    price: "20.77",
  ...
  },
  {
    ...
    directions:
      "Before shampooing, dampen hair and apply Nº3 Hair Perfector™ from roots to ends. Leave on for 10 minutes for maximum effects. Rinse well, then shampoo and condition.",
  ...
  },
  {
    ...
    directions:
      "Apply to wet hair. Concentrate on scalp and work through to ends. Lather fully and leave on up to 5 minutes. Rinse well.",
  ...
  },
  {
    ...
    description:
      "100% Organic Cold-Pressed Moroccan Argan Oil is a cold-pressed, organic oil that naturally hydrates the skin while combating dryness and supporting healthy-looking skin. Argan oil is rich in fatty acids, vitamins, and other compounds, which allows it to also be used in hair, increasing softness and sheen.",
    category: ["hair"],
    price: "12.00",
    product_type: ["Oil"],
  ...
  },
  {
    ...
    directions:
      "Apply 1-2 pumps to towel-dried hair. Distribute product throughout hair and diffuse to activate and define curls. For a more relaxed curl, let hair dry naturally.",
  ...
  },
  {
    ...
    brand: "Shu Uemura",
    ingredient_list:
      "Aqua/Water, Cyclohexasiloxane, Cyclopentasiloxane, Ci 19140/Yellow 5, Ci 15985/Yellow 6, C13-14 Isoparaffin, Hydroxycitronellal, Phenoxyethanol, Polyacrylamide, Dimethiconol, Camellia Japonica Seed Oil, Isoeugenol, Laureth-7, Hexyl Cinnamal, Glycerin, Parfum/Fragrance.⁠",
    description:
      "A nourishing overnight serum featuring Japanese Red Camellia Oil that hydrates hair while you sleep to deliver shiny, soft, and less-frizzy hair by morning.",
    category: ["hair"],
    price: "80.00",
    product_type: ["Serum"],
    ...
    directions:
      "Before bedtime, apply one to two pumps to dry or damp hair's mid-lengths and ends, using a comb or brush for even distribution. Leave it in overnight as the lightweight formula is pillow-proof. No need to rinse in the morning; simply style hair as usual.",
...
export const actives = {
  "Ascorbic Acid":
    "A potent antioxidant that helps brighten the skin, even out skin tone, and protect against environmental damage. It also aids in collagen production and reduces the appearance of fine lines and wrinkles.",
  "Azelaic Acid":
    "Helps to unclog pores, reduce inflammation, and minimize the appearance of blemishes and redness. It can also regulate skin pigmentation, making it beneficial for hyperpigmentation concerns.",
  "Glycolic Acid":
    "An exfoliating ingredient that helps remove dead skin cells, improve skin texture, and promote a brighter complexion. It stimulates collagen production, reduces the appearance of fine lines, and enhances the absorption of other skincare products.",
  ...
  Niacinamide:
    "Helps to regulate oil production, improve skin's elasticity, and minimize the appearance of pores and fine lines. It also strengthens the skin barrier, evens out skin tone, and reduces redness and blotchiness.",
  Peptides:
    "These amino acid compounds support collagen production, promote skin firmness, and help reduce the appearance of wrinkles. They can improve skin elasticity, hydration, and overall texture, resulting in a more youthful-looking complexion.",
  Retinol:
    "A form of vitamin A that aids in reducing the appearance of fine lines, wrinkles, and uneven skin tone. It stimulates cell turnover, increases collagen production, and improves skin texture and firmness. It is important to use retinol products with caution and gradually build tolerance.",
  "Salicylic Acid":
    "Effective for treating acne-prone skin by unclogging pores, reducing inflammation, and promoting clearer skin. It helps to exfoliate the skin's surface and penetrate into the pores, preventing acne breakouts and improving overall skin texture.",
  Ceramides:
    "Essential lipids that help form the skin's protective barrier and retain moisture. They strengthen the skin's natural barrier function, improve hydration, and protect against environmental stressors. Ceramides are beneficial for dry and damaged skin, helping to restore and maintain a healthy skin barrier.",
  Petrolatum:
    "A highly effective occlusive ingredient that forms a protective barrier on the skin's surface. It helps to prevent moisture loss, soothe and protect dry, chapped, or irritated skin. Petrolatum is commonly used in skincare products to provide long-lasting hydration and promote skin healing.",
  "Colloidal Oatmeal":
    "A natural ingredient derived from finely ground oats, colloidal oatmeal has soothing and calming properties. It forms a protective barrier on the skin, helps retain moisture, and reduces itching and redness. It is commonly used to alleviate dry, itchy, and irritated skin conditions, including eczema.",
  "Lactic Acid":
  ...
  return (
    <div>
      <section id="homepage">
        <div class="image-container">
          ...
          <div class="black-box">
            <div className="text-light text-center my-5">
              <h3>Science-Driven Skincare for All</h3>
              <p>
                <br /> Brains & Beauty is an online store <br /> founded by a
                group of cosmetic chemists and <br /> dermatologists in 2020.{" "}
                <br />
                <br /> Our mission is to provide a carefully curated <br />{" "}
                selection of affordable and effective
                <br /> products based on the latest research.
              </p>
        ...
        <div>
          <h3 className="mt-5 text-center">Our Best Sellers</h3>
        </div>
        <div className="m-4">
