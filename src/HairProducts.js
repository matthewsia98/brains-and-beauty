...
const productType= ['Shampoo', 'Conditioner', 'Treatment', 'Mask', 'Cream', 'Oil', 'Serum'];
const hairBrands = ['Aveeno', 'The Ordinary', 'Olaplex', 'MORROCANOIL', 'Shu Uemura'];
  ...
  const [priceFilter, setPriceFilter] = useState('0')
    ...
    return (     
      <div>
        ...
        <img src={hairProds} alt="kid applying hairscreen" style={{ width: '100%' }} />  
        <div style={{ position: 'absolute', top: '25%', right: '5%', zIndex: 1 }}>
            <h2>Hair Care</h2>
            <p className="mt-3" style={{ fontSize: '1.5vw' }}>Let us help you unlock healthy hair!</p>
        </div>
        </div>
